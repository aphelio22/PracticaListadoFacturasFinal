...
class InvoiceAdapter (private var invoicesList: List<InvoiceResponse>, private val onCLickListener: (InvoiceResponse) -> Unit): RecyclerView.Adapter<InvoiceViewHolder> () {
